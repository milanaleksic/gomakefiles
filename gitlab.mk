...
${APP_NAME}_linux_arm5: $(RELEASE_SOURCES)
	...
	PATH=$$PATH:. goupx --strip-binary -q ${APP_NAME}_linux_arm5
...
${APP_NAME}_linux_arm6: $(RELEASE_SOURCES)
	...
	PATH=$$PATH:. goupx --strip-binary -q ${APP_NAME}_linux_arm6
...
${APP_NAME}_linux_arm7: $(RELEASE_SOURCES)
	...
	PATH=$$PATH:. goupx --strip-binary -q ${APP_NAME}_linux_arm7
...
${APP_NAME}_linux_amd64: $(RELEASE_SOURCES)
	...
	PATH=$$PATH:. goupx --strip-binary -q ${APP_NAME}_amd64
